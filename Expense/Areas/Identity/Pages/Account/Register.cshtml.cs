...
namespace Expense.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [Display(Name = "CostUnit Code")]
            public string CostUnitCode { get; set; }

            [Required]
            [Display(Name = "CostUnit Name")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser();
                //user.CostUnitCode = Input.CostUnitCode;
                //user.CostUnitName = Input.CostUnitName;
                ...
                var user = new ApplicationUser
                {
                    ...
                    Email = Input.Email,
                    CostUnitCode = Input.CostUnitCode,
                    CostUnitName = Input.CostUnitName
                };
